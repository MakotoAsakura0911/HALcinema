...
if(isset($_POST["submit01"])){    //入力ページから確認ページ
    ...
    $ps2 = $_POST["pass02"];
    	...
    	header('Location: check.php?sei='.$_POST["sei"].'&mei='.$_POST["mei"].'&ksei='.$_POST["ksei"].'&kmei='.$_POST["kmei"].'&radioprice='.$_POST["radioprice"].'&ken='.$_POST["ken"].'&nen='.$_POST["nen"].'&tuki='.$_POST["tuki"].'&hi='.$_POST["hi"].'&cal='.$_POST["cal"].'&address='.$_POST["address"].'&pass='.$pass.'');
    	exit();
    }
}
