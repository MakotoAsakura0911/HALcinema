...
//insert文
require_once("core/upinsert.php");
//メール送信
...
$level = '';
//使用するcssを記入
$css = '<link rel="stylesheet" href="'.$level.'css/mypage.css" type="text/css" /><link rel="stylesheet" href="'.$level.'css/signok2.css" type="text/css" />';
...
<article>
    ...
    <div class="content right_main">
                <p>ユーザーの更新が完了いたしました。</p>
    <a href="mypage.php">マイページトップへ</a>
    </div>
</article>
<!--ここまででコンテントの内容終わる　-->
<?php html_footer(); ?>
